...
Tadzhik_control_panel_wxFrame::Tadzhik_control_panel_wxFrame(wxWindow* parent,wxWindowID id)
{
    ...
    int GLCanvasAttributes_1[] = {
    	...
    	GLCanvas1 = new wxGLCanvas(Panel1, ID_GLCANVAS1, GLCanvasAttributes_1, wxPoint(0,0), wxSize(600,496), 0, _T("ID_GLCANVAS1"));
    #else
    	GLCanvas1 = new wxGLCanvas(Panel1, ID_GLCANVAS1, wxPoint(0,0), wxSize(600,496), 0, _T("ID_GLCANVAS1"), GLCanvasAttributes_1);
    #endif // wxCHECK_VERSION
    Notebook1 = new wxNotebook(Panel1, ID_NOTEBOOK1, wxPoint(600,0), wxSize(300,500), 0, _T("ID_NOTEBOOK1"));
    ...
    MakePathButton = new wxButton(Panel1, ID_BUTTON1, _("Make Path"), wxPoint(608,504), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
    SmoothPathButton = new wxButton(Panel1, ID_BUTTON2, _("Smooth"), wxPoint(696,504), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
    Button3 = new wxButton(Panel1, ID_BUTTON3, _("Show 3D"), wxPoint(784,504), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
    ...
    portChoice = new wxChoice(Panel1, ID_CHOICE1, wxPoint(904,507), wxSize(104,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE1"));
    ...
    ConnectButtom = new wxButton(Panel1, ID_BUTTON4, _("Connect"), wxPoint(1016,504), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
    DisconnectButton = new wxButton(Panel1, ID_BUTTON5, _("Disconnect"), wxPoint(1104,504), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
    CommandTextCtrl = new wxTextCtrl(Panel1, ID_TEXTCTRL4, wxEmptyString, wxPoint(904,536), wxSize(184,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
    SendButton = new wxButton(Panel1, ID_BUTTON6, _("Send"), wxPoint(1104,533), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON6"));
    StartButtom = new wxButton(Panel1, ID_BUTTON7, _("Start"), wxPoint(608,536), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON7"));
    ...
    StopButton = new wxButton(Panel1, ID_BUTTON8, _("Stop"), wxPoint(696,536), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON8"));
    ...
    Button2 = new wxButton(Panel1, ID_BUTTON9, _("Pause"), wxPoint(784,536), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON9"));
    ...
    wxFont XYZTextFont(20,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
    ...
    wxFont NormVTextFont(20,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
    NormVText->SetFont(NormVTextFont);
    StaticText2 = new wxStaticText(Panel1, ID_STATICTEXT4, _("Set velocity (mm/s):"), wxPoint(904,571), wxDefaultSize, 0, _T("ID_STATICTEXT4"));
    VelocityTextCtrl = new wxTextCtrl(Panel1, ID_TEXTCTRL5, _("30"), wxPoint(1008,568), wxSize(80,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
    SetVelocityButton = new wxButton(Panel1, ID_BUTTON10, _("Set"), wxPoint(1104,568), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON10"));
    StartPrintheadButton = new wxButton(Panel1, ID_BUTTON11, _("Printhead ON"), wxPoint(904,600), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON11"));
    StopPrintheadButton = new wxButton(Panel1, ID_BUTTON12, _("Printhead OFF"), wxPoint(1000,600), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON12"));
